      ...
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px', background: 'radial-gradient(circle at top, #1b0b12 0, #050109 45%, #000000 100%)', color: '#f8fafc', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', maxWidth: '400px' }}>
          ...
          <button
            ...
            style={{ padding: '12px 24px', background: '#f97373', color: '#0f172a', border: 'none', borderRadius: '999px', fontSize: '14px', fontWeight: 600, cursor: 'pointer', letterSpacing: '0.1em', textTransform: 'uppercase', boxShadow: '0 0 16px rgba(248,113,113,0.4)' }}
          >
            Log in by team name
          </button>
        </div>
    ...
    <div className="ultron-team-dashboard" style={{
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div style={{
          ...
          {/* Add Members Form */}
          {showAddMembers && (
            <div style={{ marginTop: '16px', padding: '16px', background: 'rgba(30,27,45,0.5)', border: '1px solid rgba(148,163,184,0.2)', borderRadius: '10px' }}>
              ...
              {addMembersError && (
                <div style={{ padding: '10px 12px', marginBottom: '12px', background: 'rgba(239,68,68,0.15)', border: '1px solid rgba(239,68,68,0.4)', borderRadius: '8px', color: '#f87171', fontSize: '13px' }}>
                  {addMembersError}
                </div>
              )}
              {addMembersSuccess && (
                <div style={{ padding: '10px 12px', marginBottom: '12px', background: 'rgba(16,185,129,0.15)', border: '1px solid rgba(16,185,129,0.5)', borderRadius: '8px', color: '#34d399', fontSize: '13px', display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                {newMembers.map((member, idx) => (
                  <div key={idx} style={{ display: 'flex', flexDirection: 'column', gap: '8px', padding: '12px', background: 'rgba(15,15,22,0.6)', border: '1px solid rgba(148,163,184,0.15)', borderRadius: '8px' }}>
          ...
          <div style={{
            ...
            {!showTeamQR ? (
              ...
              <div style={{ animation: 'qrFadeIn 0.3s ease-out' }}>
                ...
                <div style={{ textAlign: 'center', padding: '16px', background: 'rgba(30,27,45,0.5)', borderRadius: '12px', border: '1px solid rgba(148,163,184,0.2)' }}>
                  {teamQrDataUrl && <img src={teamQrDataUrl} alt="Team QR" style={{ width: 200, height: 200, display: 'block', margin: '0 auto 12px', background: '#fff', borderRadius: '10px', padding: '10px', boxSizing: 'border-box' }} />}
        ...
        <div style={{
          ...
          {reviewError && (
            <div style={{ padding: '12px', marginBottom: '16px', background: 'rgba(239,68,68,0.15)', border: '1px solid rgba(239,68,68,0.4)', borderRadius: '8px', color: '#f87171', fontSize: '14px' }}>
              {reviewError}
            </div>
          )}
