 ...
 * Re-exports all page components for App routing.
 */
export { default as CertVaultHome } from './components/CertVaultHome';
export { default as CertVaultHowItWorks } from './components/CertVaultHowItWorks';
